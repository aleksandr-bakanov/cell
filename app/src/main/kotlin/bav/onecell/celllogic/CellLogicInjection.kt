...
class CellLogicModule {
    @Provides
    @FragmentScope
    fun provideRulesPresenter(cellRepository: RepositoryContract.CellRepo): Rules.Presenter {
        return RulesPresenter(cellRepository)
    }

    @Provides
    @FragmentScope
    fun provideConditionsPresenter(cellRepository: RepositoryContract.CellRepo): Conditions.Presenter {
        return ConditionsPresenter(cellRepository)
    }
}
